...
const Home = () => {
  ...
  return (
    <div className=" min-h-screen bg-[#E4F8E2] dark:bg-gray-900 transition-colors duration-300">
      <div className="absolute w-full min-h-screen  flex-grow h-[750px] overflow-hidden hidden sm:hidden lg:flex flex-col justify-center">
        ...
        <div className="absolute w-full min-h-screen  flex-grow h-[750px] overflow-hidden flex sm:flex lg:hidden md:hidden flex-col justify-center">
        {/* Video Background with Low Brightness Filter */}
        <video
          autoPlay
          loop
        ...
        >
          <source src="/video/bg-vid2.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>

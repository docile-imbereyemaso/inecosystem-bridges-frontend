    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          ...
          <h1 className="scale-x-[2] scale-y-[2] pt-2">{companyData.company_name.charAt(0)}</h1>
        </span>

        <span className="block mr-1 font-medium text-theme-sm">{companyData.company_name}</span>
        <svg
